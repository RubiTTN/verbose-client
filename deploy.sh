...
# build images
docker build -t 845778257277.dkr.ecr.ap-southeast-2.amazonaws.com/$STAGE/content-client:latest -t 845778257277.dkr.ecr.ap-southeast-2.amazonaws.com/$STAGE/content-client:$SHA -f ./Dockerfile ./

# push images
docker push 845778257277.dkr.ecr.ap-southeast-2.amazonaws.com/$STAGE/content-client:latest
docker push 845778257277.dkr.ecr.ap-southeast-2.amazonaws.com/$STAGE/content-client:$SHA
